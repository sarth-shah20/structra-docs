...
The infrastructure must act on health check failures automatically:
      ...
      Container orchestrator (Kubernetes): Restart containers failing the liveness check; replace terminated
      containers with new ones.
      Auto-scaling group (AWS EC2 ASG): Terminate unhealthy instances and launch replacements
      automatically.
