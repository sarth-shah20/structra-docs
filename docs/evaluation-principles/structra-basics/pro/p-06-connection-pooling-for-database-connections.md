...
Connection Pooling Tools
      ...
      External connection pooler: PgBouncer (for PostgreSQL) or ProxySQL (for MySQL) sits between the
      application and the database, pooling connections at the infrastructure level. This is preferable at scale
      because it maintains the pool independently of application restarts.
