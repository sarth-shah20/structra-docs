...
Choose Microservices when:
      ...
      Different parts of the system have genuinely different scaling requirements (e.g., your search service
      needs 10x more capacity during sale events, but your user service does not).
      You need to use different technologies for different components.
      The system is large and mature enough that a monolith has become a bottleneck for independent
      development.
