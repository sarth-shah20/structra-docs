...
- You merge data from multiple sources — ID 42 in database A and ID 42 in database B are different entities.
- IDs are exposed in URLs — sequential IDs reveal business information (your 1000th customer, your daily order volume).
