...
- Maintenance burden: When authorization rules change (e.g., "editors can now delete, not just edit"), you must update every service that references the "editor" role.
